<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Contoso.Provision.CustomCSSWeb.Default" %>
...
<body>
 ...
 <asp:ScriptManager ID="ScriptManager1" runat="server" EnableCdn="True" />
    ...
    <div style="left: 40px; position: absolute;">
        ...
        <asp:Button runat="server" ID="btnScenario1Remove" Text="Remove custom action from site" OnClick="btnScenario1Remove_Click" />
        <br />
        <br />
    </div>
    </form>
